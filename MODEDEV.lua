...
sudo_users = {SUDO,1208165035,bot_id}
...
var = true  
if tonumber(user_id) == tonumber(20) then  
var = true  
...
if SudoBot(msg) then
local bl =  '-  𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒐𝒐𝒈𝒆𝒏 المطور الاساسي \n س 𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒐𝒐𝒈𝒆𝒏 \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/SO_ROGEN) '
local keyboard = {
	{'•معلومات الكيبورد•'},
	  {'•ضع اسم للبوت•'},
...
send(msg.sender_user_id_, msg.id_,' 𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒐𝒐𝒈𝒆𝒏 \n سيتم الرد عليك قريبا')
...
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/SO_ROGEN)}\n•["..MODEDEV_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "•عذرا يا > {["..data.first_name_.."](T.ME/SO_ROGEN)}\n• الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@SO_ROGEN','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
Text = [[
[𝑫𝒆𝒗 𝑴𝒂𝒅𝒊𝒔𝒐𝒏](t.me/SO_ROGEN) 
[𝑫𝒆𝒗 𝑬𝒍𝒌𝒂𝒃𝒐𝒐𝒔](t.me/SO_ROGEN)
[𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒐𝒐𝒈𝒆𝒏](t.me/SO_ROGEN)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'سورس 𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒐𝒐𝒈𝒆𝒏' or text == 'اريد بوت تمبلر' or text == 'سورس روجين' then
Text = [[
•- 𝑫𝒆𝒗 @AAHMEED11 مبرمج بوتات•
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == 'اريد انصب بوت' or text == 'عجبني البوت' or text == 'منو منصبلك' or text == 'منو مبرمج السورس' or text == 'مبرمج السورس' or text == 'انصبلك'  or text == 'انصبلك بوت' then
Text = [[
اهلا عزيزي
متوفر تنصيب بوتات ع سورس 𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒐𝒐𝒈𝒆𝒏
احدث واسرع البوتات وضمان الثقه
للاستفسار راسل المطور @AAHMEED11
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == '@AAHMEED11' or text == '@SO_ROGEN' or text == 'روجين' then
Text = [[
@AAHMEED11  دا مبرمج السورس
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_ROGEN')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'SO_ROGEN')..') \n*•تم قفـل الدردشه*\n')  
end,nil)   
...
send(msg.chat_id_, msg.id_,'•  𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒐𝒐𝒈𝒆𝒏 •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
...
-----------------------------------------------------
if text == 'رفع زوجتي' and Mod(msg) then
...
local UserName = (b.username_ or "SO_ROGEN")
...
if text == ""..(database:get(bot_id..'Name:Bot') or '𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒐𝒐𝒈𝒆𝒏').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or '𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒐𝒐𝒈𝒆𝒏')
local MODEDEV_Msg = {
'ۿۧهلا ؏ـمࢪي .',
...
if text == ""..(database:get(bot_id..'Name:Bot') or '𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒐𝒐𝒈𝒆𝒏').." غادر" or text == 'بوت غادر' then  
...
Text = ' • عدد جهاتك > ['..Num..'](https://t.me/SO_ROGEN) •'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
*⑥ اومر التسليه*
*•●○●○●○●○●•ٴ*
𝘊𝘩 - [𝑴𝒂𝒅𝒊𝒔𝒐𝒏](t.me/AAHMEED11)•
𝘊𝘩 - [𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒐𝒐𝒈𝒆𝒏](t.me/SO_ROGEN)•
𝘊𝘩 - [𝑬𝒍𝒌𝒂𝒃𝒐𝒔](t.me/G_W_P)•
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒐𝒐𝒈𝒆𝒏 - SoUrCe](https://t.me/SO_ROGEN)
]]
...
*•الامر بالرد *
*•●○●○●○●○●•ٴ*
𝑫𝒆𝒗 - [𝑴𝒂𝒅𝒊𝒔𝒐𝒏](t.me/AAHMEED11)•
𝑪𝒉 - [𝑺𝒐𝒖𝒓𝒄𝒆 𝑹𝒐𝒐𝒈𝒆𝒏](t.me/SO_ROGEN)•
𝑫𝒆𝒗 - [𝑬𝒍𝒌𝒂𝒃𝒐𝒔](t.me/G_W_P)•
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
